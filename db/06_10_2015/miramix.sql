...
--
-- Host: localhost
-- Generation Time: Oct 05, 2015 at 08:18 PM
...
INSERT INTO `brandmembers` (`id`, `fname`, `lname`, `email`, `role`, `status`, `address`, `admin_status`, `updated_at`, `date_added`) VALUES
(1, 'Gairik', 'sen', 'gairik@gmail.com', '0', 1, 1, 0, '2015-10-05 12:33:10', '2015-10-01'),
(2, 'Sumitra', 'ROy', 'sumitra@gmail.com', '1', 1, 2, 1, '2015-10-01 13:27:16', '2015-10-01');
...
INSERT INTO `components` (`id`, `name`, `weight`, `status`, `updated_at`, `created_at`) VALUES
...
(5, 'facebook', 'Facebook link', 'http://www.facebook.com/sleeplocker', 'validate[required,custom[url]]', 'text'),
(6, 'linkedin', 'Linked In link', 'http://www.linkedin.com/sleeplocker', 'validate[required,custom[url]]', 'text'),
(7, 'Twitter', 'Twitter link', 'http://www.twitter.com/sleeplocker', 'validate[required,custom[url]]', 'text');
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `remember_token`, `admin_icon`, `updated_at`, `role`) VALUES
(1, 'Amit Banerjee', 'test@gmail.com', '$2y$10$aKO06AwK8jN7eXibuqo1jO4cv3l5KH3STMY8mOWAEN72IbzW5gg/G', 'vnUxdeU7BiuY66pKDdU8TZJze6BWOAeVCRz7I8m5rVI16wvAAOlTDSiSYIYY', '691469349.jpeg', '2015-10-05 11:01:21', 1);
...
(3, 'B1', '10', 1, '2015-09-22 18:10:13', '2015-09-22 17:11:13'),
(5, 'B6', '20', 1, '2015-09-24 04:09:38', '2015-09-24 04:09:38'),
(6, '', '', 1, '2015-10-05 01:15:06', '2015-10-05 01:15:06');
...
--
ALTER TABLE `address`
  ADD CONSTRAINT `address_ibfk_1` FOREIGN KEY (`mem_brand_id`) REFERENCES `brandmembers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
