...
class FormfactorController extends Controller {
   ...
   public function index($param = false)
   {
    ...
    public function store(Request $request)
    {
        ...
        $formfactors['image']= $fileName;

        FormFactor::create($formfactors);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (Input::hasFile('image'))
        {
            ...
            Input::file('image')->move($destinationPath, $fileName);            // uploading file to given path
            //echo $fileName; exit;
            $formfactorUpdate['image']=$fileName;
            // Unlink old image
        ...
        {
            $formfactorUpdate['image'] = Request::input('hidden_image');
        }
        
        $formfactor->update($formfactorUpdate);
