  ...
  <table width="620" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td background="http://miramix-development.com/public/frontend/images/account/acct_back.jpg" style="background-repeat:no-repeat;background-position:0 0;background-size:cover;padding-left:30px;padding-top:30px;padding-right:30px;" bgcolor="#017a95"><table width="560" border="0" cellpadding="0" cellspacing="0" style="">
          ...
          <tbody>
            <tr>
              <td id="top_part" height="70" background="http://www.phppowerhousedemo.com/webroot/design/demos/gonnadive/emailtemplate/top_image.png" style="background-repeat:no-repeat;background-size:cover;background-position:right 0;"></td>
            </tr>
            <tr>
              <td style="padding-left:30px;padding-right:30px;" bgcolor="#f8f8f8"><table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                  <tr>
                    <td align="center"><p style="font-size:20px;line-height:22px;color:#1588d1;font-family:'Lato', sans-serif;font-weight:700;display:block;text-align:center;margin:0;margin-bottom:20px;display:block;">Thank you for your order from miramix store.</p>
                      ...
                      <p style="font-size:14px;line-height:22px;color:#4e4e4e;font-family:'Lato', sans-serif;margin:0;margin-bottom:30px;"><span style="font-weight:700;">Your order #200000050</span><br>
                        Placed on July 14, 2015 7:20:48 AM GMT</p></td>
                  </tr>
                  <tr>
...
{!! (isset($mailing_name) && ($mailing_name!=''))?ucwords($mailing_name):'' !!}<br>
                ...
                ?>
                        ...
                        <tfoot>
                          <tr>
                            ...
                            <td style="font-size: 12px; border-right: 1px solid #dddddd; border-bottom: 1px solid #dddddd; text-align: right; padding: 7px">${!! $order_list->sub_total !!}</td>
                          </tr>
                          <tr>
                            ...
                            <td style="font-size: 12px; border-right: 1px solid #dddddd; border-bottom: 1px solid #dddddd; text-align: right; padding: 7px">${!! $order_list->shipping_cost !!}</td>
                          </tr>
                          <tr>
                            ...
                            <td style="font-size: 12px; border-right: 1px solid #dddddd; border-bottom: 1px solid #dddddd; text-align: right; padding: 7px">${!! $order_list->order_total !!}</td>
                          </tr>
                        </tfoot>
                      </table></td>
                  </tr>
