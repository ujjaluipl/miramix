                ...
                <div class="row signup_form_panel">
                	...
                	<div class="col-sm-4">
                        ...
                        <div class="input-group wow slideInRight md15">
                            {!! Form::text('user_name',null,['class'=>'form-control','placeholder'=>'Username', 'id'=>'user_name','aria-describedby'=>'basic-addon2','onblur' =>'usernameChecking(this.value)', 'autocomplete'=>'off'])!!}

                        <label id="user_name_error" class="error">username is already exist.</label>
                        </div>
                        
                        <div class="input-group wow slideInLeft md15">
                            {!! Form::password('password',['class'=>'form-control','placeholder'=>'Password', 'aria-describedby'=>'basic-addon3', 'id'=>'password', 'autocomplete'=>'off'])!!}
                    	</div>
                    ...
                    <div class="col-sm-4">
                    	<div class="input-group wow slideInLeft md15">
                            {!! Form::text('email',null,array('class'=>'form-control','id'=>'email','placeholder'=>'Email', 'aria-describedby'=>'basic-addon2','onblur' =>'emailChecking(this.value)', 'autocomplete'=>'off'))!!}
                            
                            <label id="email_error" class="error">Email-Id is already exist.</label>
                        </div>
                       
                        <div class="input-group wow slideInRight md15">
     {!! Form::password('con_password',array('class'=>'form-control','placeholder'=>'Confirm Password', 'aria-describedby'=>'basic-addon3', 'autocomplete'=>'off'))!!}
                    	</div>
